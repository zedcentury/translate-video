"""2-bosqich: videoning audio qismini nutqsiz fon audiosiga almashtirish.

1-bosqichda demucs ajratib bergan `<nom>-background.wav` faylini videoga
...
def replace_audio(
    ...
    Args:
        ...
        background_audio: Nutqsiz fon audiosi (1-bosqich natijasi). Berilmasa,
