...
Bosqichlar ketma-ketligi:
    ...
    5. step5_translate_srt  — .srt ni tarjima qilish (LLM — rejada)
    6. step6_normalize_srt  — matnlarni TTS uchun normalize qilish (uztts)
    7. step7_generate_audios— tarjimadagi matnlarni audioga o'girish (Navoiy TTS)
    8. step8_merge_audios   — audiolarni videoga timestamp bo'yicha biriktirish (ffmpeg)

Diqqat: 3-bosqich transkripsiya uchun ASL videodan audio oladi (nutq o'sha yerda),
...
from step4_generate_srt import generate_srt
from step5_translate_srt import translate_srt
from step6_normalize_srt import normalize_srt
from step7_generate_audios import generate_audios
